export const es = {
  ...
  onboardingFlow: {
    ...
    appDescription: 'Esta alarma no se detiene hasta que escanees un código QR o de barras. Incluso el código de barras de cualquier producto que hayas comprado funciona. Colócalo en algún lugar al que tengas que caminar y nunca más te quedarás dormido.',
    nameLabel: 'Apodo',
    ...
    focusModeButton: 'Abrir Ajustes de Concentración',
    focusSleepTitle: 'Permitir alarma durante el sueño',
    focusSleepDesc: 'ScanAlarm necesita sonar incluso con el modo de concentración activo. Activa las "Notificaciones urgentes" para esta app.',
    focusGuideStep1: 'Abre Ajustes → ScanAlarm → Notificaciones',
    focusGuideStep2: 'Activa "Notificaciones urgentes"',
    focusGuideStep3: 'Esto permite que las alarmas suenen en TODOS los modos (Sueño, No molestar, Trabajo, etc.)',
    openFocusSettings: 'Abrir Ajustes de Concentración',
    openNotificationSettings: 'Abrir Ajustes de Notificaciones de ScanAlarm',
    focusSkip: 'Configurar más tarde',
  ...
  scan: {
    ...
    cameraSettingsHint: 'Puedes permitir el acceso a la cámara desde la app de Ajustes.',
    openSettings: 'Abrir Ajustes',
    backToHome: 'Volver al inicio',
    allowCamera: 'Permitir',
    cameraAllowHint: 'Se necesita la cámara para desactivar alarmas. Toca "Permitir" para continuar.',
    cameraBlocked: 'El acceso a la cámara está bloqueado',
    cameraBlockedHint: 'Ve a Ajustes > Privacidad y seguridad > Cámara > ScanAlarm para permitir el acceso.',
    openPrivacySettings: 'Abrir Ajustes de Privacidad',
