export const en = {
  ...
  onboarding: {
    ...
    description: 'Register a QR code or barcode to dismiss your alarm. A toothbrush, water bottle, or any commercial product barcode works perfectly.',
  ...
  onboardingFlow: {
    ...
    focusModeButton: 'Open Focus Settings',
    // Focus/Sleep dedicated step
    focusSleepTitle: 'Allow Alarm During Sleep',
    focusSleepDesc: 'ScanAlarm needs to ring even when Focus or Sleep mode is active. The easiest way is to enable Time Sensitive Notifications for this app.',
  ...
  /** Short subtitle shown under each sound name. */
  soundDescriptions: {
    gentle: 'Soft awakening',
    gentle_chime: 'Crystal chime',
    gentle_harp: 'Gentle harp',
    gentle_musicbox: 'Nostalgic melody',
    gentle_delicate: 'Delicate tone',
    gentle_morning_suno: 'Morning glow',
    gentle_soft: 'Smooth & quiet',
    nature: 'Calm nature',
    nature_birds: 'Birdsong',
    nature_ocean: 'Ocean waves',
    nature_rain: 'Light rain',
    digital: 'Simple electronic',
    digital_beep: 'Clear beep',
    digital_chiptune: 'Retro chiptune',
    digital_synth: 'Synth wave',
    digital_classic_beep: 'Classic beep',
    digital_morning_beep: 'Morning beep',
    digital_robotic: 'Robotic',
    urgent: 'Wakes you up',
    loud_alarm: 'Standard alarm',
    loud_buzzer: 'Loud buzzer',
    loud_siren: 'Siren',
    loud_alarm_clock: 'Classic alarm clock',
    loud_analog_clock: 'Analog clock',
    loud_classic_alarm: 'Classic alarm tone',
    loud_emergency_siren: 'Emergency siren',
    loud_police: 'Police siren',
    loud_crowd_scream: 'Loud screams',
    loud_rock: 'Upbeat rock',
    loud_siren_long: 'Long siren',
    classical_orchestra: 'Full orchestra',
    classical_piano: 'Bright piano',
    classical_violin: 'Beautiful violin',
    classical_symphony: 'Epic symphony',
    motivational_energy: 'Energy boost',
    motivational_inspire: 'Inspiring',
    motivational_upbeat: 'Bright & upbeat',
    motivational_epic_cinema: 'Cinematic epic',
    fun_rooster: 'Cheerful rooster',
    fun_chicken: 'Chicken sounds',
    fun_dog_bark: 'Dog barks',
    fun_dog_beg: 'Begging dog',
    voice_akira_ja: 'Wake-up voice (JA)',
    voice_coach_en_short: 'Coach short (EN)',
    voice_coach_en_long: 'Coach long (EN)',
    voice_cheerful_en_1: 'Cheerful 1 (EN)',
    voice_cheerful_en_2: 'Cheerful 2 (EN)',
